...
class Utils {
  ...
  static Iterable<JsonPathMatch> parseFromJsonPath(
      String? jsonPathExpParam, String jsonContent) {
  ...
  static Iterable<JsonPathMatch> parseObjByJsonPath(
      String? jsonPathExpParam, Object jsonObj) {
    var jsonPathExp = jsonPathExpParam ?? "";
    if (jsonPathExp == "") {
      var tmpPath = JsonPath(r'$.data');
      return tmpPath.read({"data": ""});
  ...
  static String gbkDecoder(List<int> responseBytes, RequestOptions options,
  ...
  static Map<String, String> buildHeaders(
      String url, String? contentType, Map<String, dynamic>? oldHeaders) {
